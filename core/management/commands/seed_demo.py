...
PRODUCTS = [
    ('Necklaces', 'Copper Chain Reaction Pendant', '285.00',
     'Hand-linked copper chain with a hammered pendant. Each link is closed by hand, so no two sit exactly alike.'),
    ('Necklaces', 'Malachite Drop Necklace', '420.00',
     'Zambian malachite set on a fine brass chain. The stone is cut to keep its natural banding.'),
    ('Necklaces', 'Twisted Wire Choker', '190.00',
     'Two strands of copper wire twisted into a close-fitting choker with an adjustable clasp.'),
    ('Bracelets', 'Hammered Cuff', '235.00',
     'A wide copper cuff, hammered for texture and shaped to sit flat on the wrist.'),
    ('Bracelets', 'Beaded Kwacha Bracelet', '150.00',
     'Glass beads strung on waxed cord with a copper bead clasp. Sits comfortably under a sleeve.'),
    ('Bracelets', 'Braided Leather Wrap', '175.00',
     'Soft leather braided around a copper core, wrapping twice around the wrist.'),
    ('Earrings', 'Hoop Reaction Earrings', '165.00',
     'Lightweight copper hoops with a subtle hammered finish. Barely there once they are on.'),
    ...
    ('Rings', 'Hammered Gold Band', '310.00',
     'A brass band with a hammered face, sealed to keep its shine. Made to order in your size.'),
    ('Rings', 'Wire Wrap Ring', '95.00',
     'Copper wire wrapped into an open band that adjusts to fit.'),
